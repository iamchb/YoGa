...
public class FrozenAdapter extends BaseRecyclerAdapter<FrozenAdapter.SimpleAdapterViewHolder> {
    private List<Curriculum> list;
//    private int largeCardHeight, smallCardHeight;
    private Context context;
    public FrozenAdapter(List<Curriculum> list, Context context) {
        this.list = list;
...
//    }
    ...
    public SimpleAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem) {
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_frozen, parent, false);
